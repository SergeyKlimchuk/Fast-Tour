...
begin
case MessageDlg('¬ы точно хотите выйти?',mtConfirmation , [mbYes,mbCancel], 0) of
...
With DataModule2.Tour_Query do
  ...
  Active:= True;
  End;
Lbl_Records_count.Caption:= 'ѕо вашему запросу было найдено: ' + IntToStr(DataModule2.Tour_Query.RecordCount) + ' записей!';
BUILD_PAGE(1);
end;
